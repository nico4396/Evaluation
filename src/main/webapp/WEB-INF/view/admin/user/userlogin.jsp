...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="font-size: 50px">
        <div align="center">
            <h4 style="margin: 10px 0 20px 0">用户列表</h4>
        ...
        <script type="text/html" id="toolbarDemo">
            <div align="right">
                <div class="layui-input-inline">
                    <input type="text" id="uname" name="uname" placeholder="请输入用户名" class="layui-input">
                </div>
                <div class="layui-input-inline">
            ...
            layui.use(['table','layer'], function(){
                ...
                table.render({
                    ...
                    ,cols: [[ //表头
                        ...
                        ,{field: 'pwd', title: '密码', width:200,hide:true}
                        ,{field: 'power', title: '权限', width:320}
                ...
                table.on('toolbar(test)', function(obj){
                    switch(obj.event){
                        case 'query':
                            //获取查询条件
                            var filter = $("#uname").val();
                            table.reload("demo",{//demo对应的是table的id
                                where:{uname:filter},//where对应的是过滤条件
                                page:{
                                    curr:1
                                }
                            });
