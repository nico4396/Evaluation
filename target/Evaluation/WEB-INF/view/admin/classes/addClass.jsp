...
<div class="layui-layout layui-layout-admin">
    ...
    <div style="display: flex;justify-content: center">
        <div class="layui-form">
            <h1 align="center" style="margin: 30px 0px 20px 0px">班级添加</h1>
            <div class="layui-form-item">
                <label class="layui-form-label">班级名</label>
                <div class="layui-input-inline">
                    <input id="classname" type="text" name="classname" required  lay-verify="required" placeholder="请输入科目名" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">教师名：</label>
                <div class="layui-input-block">
                    <select id="teaid" style="float: left" name="teaid">
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="formDemo" type="submit" id="addClassbtn">立即提交</button>
