...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="font-size: 50px">
        <div align="center">
            <h4 style="margin: 10px 0 20px 0">班级列表</h4>
            ...
            layui.use(['table','layer'], function(){
                ...
                table.render({
                    ...
                    ,cols: [[ //表头
                        ...
                        ,{field: 'classid', title: '编号', width:80, sort: true,hide:true}
                        ,{field: 'classname', title: '班级名', width:400}
                        ,{field: 'teaid', title: '教师编号', width:200,hide:true}
                        ,{field: 'teaname', title: '教师姓名', width:320}
                    ...
                    switch(obj.event){
                        case 'query':
                            ...
                            table.reload("demo",{//demo对应的是table的id
                                where:{classname:filter},//where对应的是过滤条件
                                page:{
                                    curr:1
                                }
                            });
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    layer.open({
                                        ...
                                        title: '修改信息',
                                        shadeClose: true,
                                        content: 'editClass?teaid='+teaid+'&teaname='+teaname,
                                        area: ['480px', '500px'],
                                        end: function () {
